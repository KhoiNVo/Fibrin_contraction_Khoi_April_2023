...
data_simple2=load_object("data_low.pickle") #low sim data
data_simple3=load_object("data_high.pickle") #high sim data
...
data_simple2.iat[0,1].normalized_fiber_plt_density[0:minlength2],
data_simple2.iat[0,2].normalized_fiber_plt_density[0:minlength2],
data_simple2.iat[0,3].normalized_fiber_plt_density[0:minlength2],
data_simple2.iat[0,4].normalized_fiber_plt_density[0:minlength2],
...
data_simple2.iat[0,7].normalized_fiber_plt_density[0:minlength2],
data_simple2.iat[0,8].normalized_fiber_plt_density[0:minlength2],
data_simple2.iat[0,9].normalized_fiber_plt_density[0:minlength2],
data_simple2.iat[0,0].normalized_fiber_plt_density[0:minlength2]])
...
data_simple3.iat[0,1].normalized_fiber_plt_density[0:minlength3],
data_simple3.iat[0,2].normalized_fiber_plt_density[0:minlength3],
data_simple3.iat[0,3].normalized_fiber_plt_density[0:minlength3],
data_simple3.iat[0,4].normalized_fiber_plt_density[0:minlength3],
...
data_simple3.iat[0,7].normalized_fiber_plt_density[0:minlength3],
data_simple3.iat[0,8].normalized_fiber_plt_density[0:minlength3],
data_simple3.iat[0,9].normalized_fiber_plt_density[0:minlength3],
data_simple3.iat[0,0].normalized_fiber_plt_density[0:minlength3]])
...
ax2.fill_between(np.squeeze(time3), np.squeeze(np.asarray(bound_lower)), np.squeeze(np.asarray(bound_upper)),
                 color = colorShade7, alpha = 0.15)

ax2.plot(time3, norm_density_mean3.T,
         label='High Filopodia Numbers',
         linestyle=':',
         linewidth=lineWidth, 
         color=color7)
...
#To draw ax3 experiment, use time7der, new bound_upper and neww bound_lower
...
ax3.plot(time7der, der,label='Exp. Filopodia Numbers',linestyle='-',linewidth=lineWidth, color=color1)
...
ax3.plot(time2, norm_density_vel_mean2.T,label='Low Filopodia Numbers',linestyle='dashed',linewidth=lineWidth, color=color2)

bound_upper = norm_density_vel_mean3.T+norm_density_vel_std3.T
bound_lower = norm_density_vel_mean3.T-norm_density_vel_std3.T

ax3.fill_between(np.squeeze(time3), np.squeeze(np.asarray(bound_lower)), np.squeeze(np.asarray(bound_upper)),
                 color = colorShade7, alpha = 0.15)

ax3.plot(time3, norm_density_vel_mean3.T,label='High Filopodia Numbers',linestyle=':',linewidth=lineWidth, color=color7)
...
ax3.set_ylabel('Change in Fiber Density, $\Delta f_p$',fontsize=24)
...
ax2.annotate("B", xy=(-0.20, 1.00), xycoords="axes fraction",fontsize=Fontsize_Sub)
ax3.annotate("C", xy=(-0.20, 1.00), xycoords="axes fraction",fontsize=Fontsize_Sub)
...
plot.tight_layout()
plot.savefig("D:/new_codes_April_20/figure8_final.png")