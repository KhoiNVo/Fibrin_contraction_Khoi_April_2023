...
#test the ability to read in data
...
#line 81 to line 196 is the definition of this DataFile class        
class DataFile:  
...
class SimpleDataFile:  
    ...
    def __init__(self):
        ...
        self.fiber_convex_plt=[]
        self.fiber_plt_volume=[]
    ...
    for subdir, dirs, files in os.walk(rootdir):
        ...
        if (len(simrow) > 1):
            ...
            #This is a loop for every time step
                ...
                simpleData.original_edge_strain.append(sum(temp_datafile.originalEdgeStrain)/len(temp_datafile.originalEdgeStrain))
                #simpleData.originalEdgeStrain.append(n_plt_fib_dense)
                ...
                for plt in range(0,len(temp_datafile.xPltPos)):
                    xPosPlt = temp_datafile.xPltPos[plt]   
                    yPosPlt = temp_datafile.yPltPos[plt]   
                    zPosPlt = temp_datafile.zPltPos[plt]
                    temcoord2.append([xPosPlt,yPosPlt,zPosPlt])
                ...
                hull2=ConvexHull(temcoord2)
                simpleData.fiber_convex_plt.append(hull2);
                simpleData.fiber_plt_volume.append(hull2.area);
...
#This function short3 is to test how input is put in
def data_generate_short3(data_,rootdir):
    print('test new function')
    Dir ="D:/Fibrin_resub/test_output/F1/Params__domain_23_plt_count_45_filo_count_13_maxForce_29.00_minForce_4.00_pltForceScale_0_dynamicResp_1_nonlinDynamicResp_1"
...
#Dir ="D:/Fibrin_resub/test_output"
#print(Dir)
#numSimpleSamples= 1
#data_simple1 = pd.DataFrame(numSimpleSamples*[SimpleDataFile])
#data_generate_short(data_simple1, Dir)
#print(data_simple1.shape)
#print(data_simple1.iat[0,0].time)

#conclusion: the loop does not run
#try first change dir to the / instead of the \ work to read in the files